...
class Building:
    ...
    def fire_alarm(self):
        ...
        for i, elevator in enumerate(self.elevators, start=1):
            print(f"\nElevator {i} moving to bottom floor {self.bottom_floor}")
            elevator.go_to_floor(self.bottom_floor)


# --- Testing the Building and Elevator classes with fire alarm ---
if __name__ == "__main__":
    ...
    my_building.run_elevator(3, 3)   # Elevator 3 to floor 3
